      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-12 text-center">
          ...
          <img
            src="/logo.png"
            alt="Salary Scraper"
            className="h-16 w-auto mx-auto mb-4 drop-shadow-[0_6px_18px_rgba(99,102,241,0.3)]"
          />
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight mb-3">
            About <span className="text-gradient">Salary Scraper</span>
          </h1>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {HOW_IT_WORKS_STEPS.map(step => (
              <div
                key={step.n}
                className="flex gap-5 card-surface p-5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lift"
              >
                <div className="shrink-0 w-9 h-9 rounded-xl bg-brand-gradient flex items-center justify-center shadow-lift">
