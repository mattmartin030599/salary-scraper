...
function calcHECS(income: number, year: TaxYear): number {
  // From 2025–26: new marginal system — repayment only on income above $67,000
  ...
  // 2024–25 and earlier: flat rate applied to total repayment income
  // Each entry is [lower bound of band (inclusive), rate]
  const bands: [number, number][] =
    year === '2024-25'
      ? [
          [54_435, 0.010], [62_851, 0.020], [66_621, 0.025],
          [70_619, 0.030], [74_856, 0.035], [79_347, 0.040],
          [84_108, 0.045], [89_155, 0.050], [94_504, 0.055],
          [100_175, 0.060], [106_186, 0.065], [112_557, 0.070],
          [119_310, 0.075], [126_468, 0.080], [134_057, 0.085],
          [142_101, 0.090], [150_627, 0.095], [159_664, 0.100],
        ]
      : year === '2023-24'
      ? [
          [51_550, 0.010], [59_519, 0.020], [63_090, 0.025],
          [66_876, 0.030], [70_889, 0.035], [75_141, 0.040],
          [79_650, 0.045], [84_430, 0.050], [89_495, 0.055],
          [94_866, 0.060], [100_558, 0.065], [106_591, 0.070],
          [112_986, 0.075], [119_765, 0.080], [126_951, 0.085],
          [134_569, 0.090], [142_643, 0.095], [151_201, 0.100],
        ]
      : year === '2022-23'
      ? [
          [48_361, 0.010], [55_837, 0.020], [59_187, 0.025],
          [62_739, 0.030], [66_503, 0.035], [70_493, 0.040],
          [74_723, 0.045], [79_207, 0.050], [83_959, 0.055],
          [88_997, 0.060], [94_337, 0.065], [99_997, 0.070],
          [105_997, 0.075], [112_356, 0.080], [119_098, 0.085],
          [126_244, 0.090], [133_819, 0.095], [141_848, 0.100],
        ]
      : [ // 2021-22
          [47_014, 0.010], [54_283, 0.020], [57_539, 0.025],
          [60_992, 0.030], [64_652, 0.035], [68_530, 0.040],
          [72_642, 0.045], [77_002, 0.050], [81_621, 0.055],
          [86_519, 0.060], [91_710, 0.065], [97_213, 0.070],
          [103_046, 0.075], [109_228, 0.080], [115_782, 0.085],
          [122_729, 0.090], [130_093, 0.095], [137_898, 0.100],
        ]
